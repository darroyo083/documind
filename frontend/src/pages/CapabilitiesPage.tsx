      ...
      <div className="dm-public-page">
        ...
        <main className="dm-container dm-capabilities-page-main">
          <section className="dm-capability-ledger" aria-label="DocuMind capabilities">
            <ScrollReveal as="article"><span>01 / Ingest</span><div><h2>Bring the source set together.</h2><p>Upload text-based PDFs into Spaces and keep processing states visible from the first file to the last.</p></div><Link to={PUBLIC_DEMO_MODE ? "/spaces/demo" : "/register"} className="dm-text-link">{PUBLIC_DEMO_MODE ? "Explore a prepared space" : "Create a space"} <span aria-hidden="true">→</span></Link></ScrollReveal>
