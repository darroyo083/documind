...
class TestFrozenIdentity:
    _FROZEN_BYTE_IDENTITY = {
        BACKEND_DIR / "app" / "evaluation" / "verifier_proof.py": (
            "FE731927CE4275F23ECF7E0D00BA4BF49388822BA9AD7856E42FE414BBE749BF"
        ),
        BACKEND_DIR / "app" / "evaluation" / "verifier_proof_eval.py": (
            "E636A1046AF06A53FA193E3BCE6D4419374066A7E25AEA72268FEF2FE5F339A1"
        ),
        BACKEND_DIR / "app" / "evaluation" / "verifier_proof_prompts.py": (
            "32337B5DAF423F25BF351BBF3C72A71D99C34879085A058C6E8FDB9B596D6AD1"
        ),
        BACKEND_DIR / "app" / "evaluation" / "verifier_prompt.py": (
            "DE4F7ABAD5ACB7D942C6892B96EDA68850ECFCC8F44D1C25EDD802C3B4195C39"
        ),
        BACKEND_DIR / "app" / "evaluation" / "verifier.py": (
            "48610BE15EABE3353B077B618CDD27EAD7E5F381389E5EB48DA635AEE46E7525"
        ),
        BACKEND_DIR / "app" / "evaluation" / "verifier_eval.py": (
            "F4DD6AD51A274BEE689D13C39EFA284A869CF22FF7230179A3929C78A5897A1F"
        ),
        BACKEND_DIR / "app" / "evaluation" / "verifier_framing.py": (
            "EA6EC3B38B1EEB9EFFD141484546EA223440BB68FE54BCD0850FD104E3B3CCFB"
        ),
        BACKEND_DIR / "tests" / "test_verifier_proof.py": (
            "37F6B9B4CCD09A7971D734526B17D352DA5E8B95D79E09C4480FE86A34A80756"
        ),
        BACKEND_DIR / "app" / "evaluation" / "datasets" / "verifier_holdout_v2.json": (
            "23461B48900540BB9D1821A59F5E3E41E7141D0EF1A1F324DCD819A1484E4F79"
        ),
        BACKEND_DIR / "app" / "evaluation" / "datasets" / "verifier_holdout_v3.json": (
            "C11F39D1677061B2C703C403523B15E0D794651C1EA2E38DB14C39C1DC121554"
        ),
        DEV_CASES_PATH: "859BD1441AF08A569F880F180F056A1209BAA68E01D529C2968B079CD7AC921D",
        CHALLENGE_CASES_PATH: "F033FD75527875B3C3CBA45312633B52BFFD48D143FACB82ECA03B276679CF94",
        INJECTION_CASES_PATH: "CFBB86BA3AF2FC52707D2927F37C3FAD04924AF959B5073739DF9B7A903A70B8",
        CONFIRMATION_CASES_PATH: "5174F3424A18F0421DC3CEB9CE7EC82260C3F04FCE33043ED673655CAB696DA1",
    }
